const ork = [
    {
        ...
        text: {
          ...
          p2: `The application functions as a landing page for the restaurant with its main call to action guiding the users the restaurant’s menu and to online ordering. The online ordering system is going to be a separate application that integrates with the restaurant's POS system.`,
    ...
    },
    {
        title: 'Design',
        text: {
          p1: `I initially started building a static website for the landing page, but quickly switched over to a dynamic react frontend solution, to allow the incorporation of dynamic menu and a 'daily specials' feature. `,
          ...
          p3: `The landing page design principles are a page that is beautiful and conveys the atmosphere and branding of the restaurant. The layout of the application is kept simple and focuses on the important elements that users are seeking when visiting the page. `,
          p4: ``,
        },  
    ...
    },
    {
        ...
        text: {
          ...
          p2: `My design for this feature build around the importance of visual impressions when deciding on what to eat. Presenting the menu not just in form of a simple list with dish names, but present the individual dishes visually invites the customer to order and try new items. `,
          p3: `The use of card elements are a perfect solution to display the dish information along with visuals, while also allowing a dynamic display across various screen sizes. `,
          p4: ``,
        },  
