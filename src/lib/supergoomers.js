const supergroomers = [
    {
        ...
        text: {
          ...
          p3: `The opportunity we saw was an interface that bridges the gap between customers seeking grooming services and providers offering these services. The scope of this venture was to build a portal that makes it easy for customers to find and book pet grooming appointments, while grooming service providers would benefit by receiving additional business with no added promotional or marketing cost.`,
    ...
    },
    {
      ...
      text: {
        ...
        p3: `Next the user enters their personal information and selects three dates and time options for the grooming appointment.`,
        p4: `Finally the user can review all the information before submitting the request. This information is then sent to our application backend, where we review this requests and match the user with a grooming service provider that has availability and can meet this customers service requirements.`,
      },  
  ...
  },
    {
        ...
        text: {
          ...
          p4: `At every stage of this form application users have the opportunity to go back and edit or add information and requested services. Users also have the option to add additional pets to the booking request.`,
        },  
    ...
    },
    {
        title: 'Concept',
        text: {
          p1: `The purpose of our MVP prototype, was to test if our concept can work and meets market demand. The core principle of our project that we were testing was the ability to bridge the gap between customers and service providers. We wanted to create a connection that benefits both sides and can be monetized. `,
