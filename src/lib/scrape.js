const scraper = [
  {
    ...
    text: {
      ...
      p2: `An initial barebones solution to this problem was a web-scraping script that collected prices from various retailers and stored this data in spreadsheets. This initial solution allowed to collect and track price changes, but lacked any form of an user friendly package.`,
  ...
  },
  {
    ...
    text: {
      ...
      p2: `The data editor features makes it easy to select the item category and enter the items name and data.`,
  ...
  },
  {
    ...
    text: {
      ...
      p3: `To restore data to the application the user can simply drag and the drop the backed-up json files to the upload entry forms, or select the files from machine.`,
      p4: ``,
    },
